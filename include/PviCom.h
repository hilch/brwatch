...
// PVI process object types:
typedef enum t_pobj_type 
{
	POBJ_PVI,					// global
	POBJ_LINE,					// line
	POBJ_DEVICE,				// device
	...
	POBJ_TYPE_CNT				// number of object types
} T_POBJ_TYPE;
...
#define POBJ_ACC_TYPE_INTERN		19		// read internal object type (attributes, format)
...
#define POBJ_ACC_MOD_DATA			28		// read/write module data
#define POBJ_ACC_MOD_DELETE			29		// delete module
...
#define POBJ_ACC_PVI_VERSION		211		// read PVI version string

#define POBJ_ACC_SNAPSHOT			240		// snapshot function
#define POBJ_ACC_PVILOG				241		// read/write PVI data logger parameter
#define POBJ_ACC_PVIMAN_PARAM		242		// read/write PVI manager parameter
#define POBJ_ACC_PVIMAN_EXIT		243		// stop PVI manager

#define POBJ_ACC_LINEBASE			256		// base number for advanced line services

#define POBJ_ACC_LN_COMM_DST		291		// read communication parameter
#define POBJ_ACC_LN_LKN_LIST		296		// linknode list
#define POBJ_ACC_LN_XML_LIC_STATUS	351		// read licence state (XML format)
#define POBJ_ACC_LN_XML_CPU_INFO	400		// read cpu informations (XML format)
#define POBJ_ACC_LN_XML_MOD_INFO	401		// read module informations (XML format)
#define POBJ_ACC_LN_XML_TASK_INFO	402		// read task informations (XML format)
#define POBJ_ACC_LN_XML_MOD_LIST	403		// read module list (XML format)
#define POBJ_ACC_LN_XML_MEM_INFO	404		// read storage informations (XML format)
#define POBJ_ACC_LN_XML_HW_INFO		405		// read hardware informations (XML format)
#define POBJ_ACC_LN_XML_RED_INFO	406		// read redundancy informations (XML format)
#define POBJ_ACC_LN_XML_TC_INFO		408		// read task class informations (XML format)
#define POBJ_ACC_LN_XML_LOGM_INFO	416		// read logger module info (XML format)
#define POBJ_ACC_LN_XML_LOGM_DATA	417		// read logger module data (XML format)
...
#define POBJ_EVENT_LN_XML_MOD_LIST	403		// module list event (XML format)
#define POBJ_EVENT_LN_XML_RED_CTRL	440		// redundancy event (XML format)
...
#define KWDESC_PVSPEC			"VS"		// line extended specifications
...
#define KWDESC_SNAME			"SN"		// superior data type name
#define KWDESC_TNAME			"TN"		// data type name (derived)
#define KWDESC_LOADTYPE			"LD"		// load state, memory type
#define KWDESC_INSTMODE			"IM"		// installation mode (download)
#define KWDESC_FILENAME			"FN"		// file name
#define KWDESC_MODNAME			"MN"		// module name
#define KWDESC_APPNAME			"AM"		// application module name
...
#define KWDESC_MODVERS			"MV"		// module version
...
#define KWDESC_ENHANCEDTRANSFER "ET"		// Enhanced Transfer for Up/Download

#define KWDESC_CTRL_COMMAND		"CMD"		// command on control services
#define KWDESC_CTRL_ARGUMENT	"ARG"		// argument on control services
...
#define	KWLOADTYPE_TRSF			"Trsf"		// transfer location
#define	KWLOADTYPE_PER_MEM		"PerMem"	// permanent memory
#define	KWLOADTYPE_REM_MEM		"RemMem"	// remanent memory
...
#define KWPVTYPE_STRING			"string"	// byte character string
#define KWPVTYPE_WSTRING		"wstring"	// wide character string
...
#define KWPVTYPE_DATE			"date"		// date
#define KWPVTYPE_TOD			"tod"		// time of day
...
// flags for variable attributes (KWDESC_ATTRIBUTE):
...
// flags for extended specifications (KWDESC_PVSPEC):
#define KWPVSPEC_ARRAY			'a'			// array dimension
#define KWPVSPEC_DERIVED		'v'			// derived data type
#define KWPVSPEC_ENUMERATION	'e'			// enumeration
#define KWPVSPEC_BITSTRING		'b'			// string of bits
...
#define PVICHR_INX_ON			'['			// index spezification on
#define PVICHR_INX_OFF			']'			// index spezification off
...
// following keywords overwrite corresponding function argument:
#define KWINIT_COM_TIMEOUT		"COMT"		// communication timeout (s)
#define KWINIT_RETRY_TIME		"RETR"		// message retry time (s)
...
// use function GetNextResponse:
#define SET_PVIFUNCTION			0xfffffffc
...
PVICM_EXPORT INT WINAPI PviGetNextResponse (WPARAM*		pwParam,
											LPARAM*		plParam,
											LPVOID*		phMsg,
											HANDLE		hEvent);

PVICM_EXPORT INT WINAPI PviXGetNextResponse (DWORD		hPviCom,
											 WPARAM*	pwParam,
											 LPARAM*	plParam,
											 LPVOID*	phMsg,
											 HANDLE		hEvent);
